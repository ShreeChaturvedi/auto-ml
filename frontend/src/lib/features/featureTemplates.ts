/**
 * Feature Templates — runtime data and helper functions.
 *
 * All pure type definitions live in `types/feature.ts`.
 * This module owns the concrete template data, category config, and
 * the helper functions that operate on them.
 */
